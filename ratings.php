...
<h2 class="text-center" style="margin-top: 20px">Search for a Service provider to rate</h2>
<hr>
                    ...
                    if (providers.failed == true) {
                        ...
                        providers.forEach(function(provider, i) {
                            tbody += "<tr>" +
                                ...
                                "<td> Kshs. " + provider.price + "</td>" +
                                "<td><a href='rate.php?provider=" + provider.id +
                                "' class='btn btn-primary btn-block'>Rate</a></td>";
                        });
                    }
